...
class CustomDialogue {
    ...
    showDialog(
        ...
        builder: (_) {
          return AlertDialog(
            ...
            content: GetBuilder<QuizController>(builder: (controller) {
              return Column(
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                            ...
                            width: 215.48.w,
                            child: Text(
                              'The skill level choosen determines how complex the questions would be. Take your time as the questions aren’t timed as you are can view the answers to the questions as you go.',
            ...
            actions: <Widget>[
              Align(
                ...
                child: Container(
                  ...
                  child: Text(
                    'Continue',
                    style: TextDimensions.style16joseW600White,
                  ),
                ),
              ),
            ],
  ...
  static void showCustomDialogCompleteQuiz(
    BuildContext context, {
    String okBtnText = "Yes",
    String cancelBtnText = "Cancel",
    String text = '',
            ...
            content: Column(
              ...
              children: [
                ...
                Align(
                    ...
                    child: Text(
                      '$text/$subText',
                      style: TextDimensions.style38josew600blue,
                    ))
                // Container(
                //   padding: EdgeInsets.only(left:16.w),
  ...
  static void showCustomDialogOnboardingScreen(
    BuildContext context, {
    String okBtnText = "Yes",
    String cancelBtnText = "Cancel",
    String text = '',
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
                color: Get.find<QuizController>().selectedLevel == widget.l
                    ? AppColors.lightBlue
        ...
        child: Row(
          ...
          children: [
            Text(
              widget.level,
              style: TextDimensions.style16josew600blue,
            ),
            SizedBox(
              width: 10.w,
            ),
            Container(
              ...
              child: Text(
                widget.text,
                style: TextDimensions.style13joseW400grey,
              ),
            ),
          ],
        ),
